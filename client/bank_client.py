...
class Account:
    ...
    def check_account_exists(account_name: str):
        return requests.post(ADDRESS + "/check_account_exists", params={"account_name": account_name}).json()
    ...
    def get_account_data(account_name: str):
        account_data = requests.get(ADDRESS + "/get_account_data",
                                    params={"account_name": account_name}).json()
        if account_data is None:
            return account_data
        else:
            return AccountField(**account_data)
